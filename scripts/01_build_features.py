...
from src.io.loaders import (
    load_config,
    load_cycle_metrics,
    # load_inventory,       # DEFERRED: only needed by P1/P2/P3 path
    load_rpt_measurements,
)
# DEFERRED: P1/P2/P3 not used in final pipeline — re-enable when needed
...
# DEFERRED: target functions only called by _attach_targets in the P1/P2 build path
...
# DEFERRED: _write_provenance is only called by the P1/P2/P3 build path.
# Re-enable when P1/P2/P3 are reactivated.
...
# DEFERRED: _attach_targets is only called in the P1/P2 build path
...
# DEFERRED: _target_eligibility and _cycling_file_eligibility are P2-dependent.
# Re-enable with the P1/P2/P3 build path when needed.
...
def main() -> None:
    ...
    # DEFERRED: P1/P2/P3 stages removed; always run unified-only.
    ...
    # DEFERRED: P1/P2/P3 build blocks — re-enable when P1/P2/P3 are needed.
